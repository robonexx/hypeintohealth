  ...
  return (
    <>
      ...
      <main className='w-full min-h-screen flex flex-col items-center bg-slate-400 text-black box-border lg:w-2/3 lg:m-auto'>
        <h1 className='mt-16 mb-4 py-2 bg-gradient-to-tr from-zinc-500 via-zinc-900 to-zinc-700 bg-clip-text text-transparent drop-shadow font-extrabold body-font font-black text-4xl'>Your daily routine</h1>
        <ExerciseBanner />
        <ExerciseList />
      </main>
    </>
